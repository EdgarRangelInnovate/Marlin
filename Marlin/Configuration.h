...
#define STRING_CONFIG_H_AUTHOR "(Scott Lahteine, Edgar Rangel)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Nesxtep V0.0.14 E3V2 Pro"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    // Ender-3 v2
    #define DEFAULT_Kp  21.73 // Original: 28.72
    #define DEFAULT_Ki   1.54 // Original:  2.62
    #define DEFAULT_Kd  76.55 // Original: 78.81
  #endif
#else
...
#define PIDTEMPBED
  ...
  // Configurado para Ender 3 Pro V2
  #define DEFAULT_bedKp  10.000 // Original: 462.10
  #define DEFAULT_bedKi   0.023 // Original:  85.47
  #define DEFAULT_bedKd 305.400 // Original: 624.59
  // 120V 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
  // from pidautotune
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 100, 5000 } // Original: { 500, 500, 100, 1000 }
...
#define DEFAULT_TRAVEL_ACCELERATION    500    // Original: 1000 // X, Y, Z acceleration for travel (non printing) moves
 ...
 */
//#define CLASSIC_JERK  // Original: active
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.08 // Original: 0.013 // (mm) Distance from real junction edge
 ...
 */
#define S_CURVE_ACCELERATION  // Original: disabled
 ...
 */
#define PROBE_MANUALLY // Original: disabled
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0 }  // Original: { 10, 10, 0 }
...
#define XY_PROBE_FEEDRATE     (133*60) // Original: (50*60) // (mm/min)
...
#define PROBE_OFFSET_ZMIN   -20   // Original: -10// (mm)
#define PROBE_OFFSET_ZMAX    20   // Original:  10// (mm)
...
#define MESH_BED_LEVELING // Original: disabled
...
#define ENABLE_LEVELING_AFTER_G28 // Original: disabled
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  #define GLOBAL_MESH_Z_OFFSET    // Original: disabled
  ...
  #define GRID_MAX_POINTS_X 7    // Original: 3
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
 ...
 */
#define LCD_BED_LEVELING        // Original: disabled

#if ENABLED(LCD_BED_LEVELING)
  #define MESH_EDIT_Z_STEP  0.01  // Original: 0.025 // (mm) Step size while manually probing Z axis.
  #define LCD_PROBE_Z_RANGE 4     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
  #define MESH_EDIT_MENU          // Original: disabled // Add a menu to edit mesh points
#endif

// Add a menu item to move between bed corners for manual bed adjustment
#define LCD_BED_TRAMMING         // Original: disabled

#if ENABLED(LCD_BED_TRAMMING)
  #define BED_TRAMMING_INSET_LFRB { 30, 30, 30, 30 } // (mm) Left, Front, Right, Back insets
  #define BED_TRAMMING_HEIGHT      0.0        // (mm) Z height of nozzle at tramming points
  #define BED_TRAMMING_Z_HOP       4.0        // (mm) Z raise between tramming points
  #define BED_TRAMMING_INCLUDE_CENTER         // Original: disabled // Move to the center after the last corner
...
//#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT X_CENTER  // Original: ((X_BED_SIZE - 10) / 2) // (mm) X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT Y_CENTER  // Original: ((Y_BED_SIZE - 10) / 2) // (mm) Y point for Z homing
  //#define Z_SAFE_HOMING_POINT_ABSOLUTE  // Ignore home offsets (M206) for Z homing position
#endif

// Homing speeds (linear=mm/min, rotational=°/min)
#define HOMING_FEEDRATE_MM_M { (20*60), (20*60), (4*60) } // Original: { (50*60), (50*60), (4*60) }

// Edit homing feedrates with M210 and MarlinUI menu items
#define EDITABLE_HOMING_FEEDRATE      // Original: disabled
...
#define EEPROM_CHITCHAT       // Original: disabled // Give feedback on EEPROM commands. Disable to save flash.
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
#if ENABLED(EEPROM_SETTINGS)
  #define EEPROM_AUTO_INIT    // Original: disabled // Init EEPROM automatically on any errors.
  #define EEPROM_INIT_NOW     // Original: disabled // Init EEPROM on first boot after a new build.
#endif
...
#define PREHEAT_1_FAN_SPEED     0   // Original: 255 // Value from 0 to 255
 ...
 */
#define NOZZLE_PARK_FEATURE     // Original: disabled
