...
#define CUSTOM_MACHINE_NAME "Nesxtep E3V2 4.2.2 V2.1.2.5"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
    ...
    #define DEFAULT_Kp_LIST {  21.73,  21.73 } // Original #define DEFAULT_Kp_LIST {  28.72,  28.72 }
    #define DEFAULT_Ki_LIST {   1.54,   1.54 } // Original #define DEFAULT_Ki_LIST {   2.62,   2.62 }
    #define DEFAULT_Kd_LIST {  76.55,  76.55 } // Original #define DEFAULT_Kd_LIST {  78.81,  78.81 }
  #else
    // Ender-3 v2
    #define DEFAULT_Kp  21.73 // Original #define DEFAULT_Kp  28.72
    #define DEFAULT_Ki   1.54 // Original #define DEFAULT_Ki   2.62
    #define DEFAULT_Kd  76.55 // Original #define DEFAULT_Kd  78.81
  #endif
#else
...
//#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT X_CENTER    // (mm) X point for Z homing Original ((X_BED_SIZE - 10) / 2)
  #define Z_SAFE_HOMING_Y_POINT Y_CENTER    // (mm) Y point for Z homing Original ((Y_BED_SIZE - 10) / 2)
